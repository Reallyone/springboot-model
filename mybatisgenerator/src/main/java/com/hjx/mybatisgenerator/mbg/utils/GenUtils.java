...
import com.hjx.mybatisgenerator.mbg.entity.ColumnEntity;
import com.hjx.mybatisgenerator.mbg.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.gpp" : mainPath;
		...
		for(String template : templates){
			...
			try {
				...
				throw new SDMException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new SDMException("获取配置文件失败，", e);
		}
	}
